...
<div class="container restaurant-info">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">Restaurant Details</h2>
        <a href="addRestaurant.jsp" class="btn btn-dark btn-add">+ Add New Restaurant</a>
    </div>
            ...
            <div class="card h-100">
                <div class="card-body d-flex flex-column justify-content-between">
                    ...
                    <div class="d-grid gap-2 mt-3">
                        <!-- Add Menu Button -->
                        <a href="addMenu.jsp?restaurantId=<%= res.getRestaurantId() %>" class="btn btn-primary">Add Menu</a>
